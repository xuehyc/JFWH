		...
		<div class="bg-bottom">		
			<div class="contents-wrapper">
				...
				<div class="left-col" align="left">
					...
					<a href="http://5xwar.com" class="main-services-banner left-bnr" style="background-image:url('<?php echo WoW::GetURL(); ?>wow/static/images/services/thumbnails/thumb-main-services-1.jpg');">
