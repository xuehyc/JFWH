<div class="summary-stats-bottom">
    ...
    if(is_array($professions)) {
		...
		<span class="icon-frame frame-12">
			<img src="http://www.wowdb.tw/icons/middle/inv_misc_questionmark.jpg" alt="" width="12" height="12" />
		</span>
</span>
		...
		<div class="bar border-3" style="width: %d%%"></div>
			<div class="bar-contents"><span class="profession-details">
							<span class="icon"> 
		<span class="icon-frame frame-12">
			<img src="http://www.wowdb.tw/icons/middle/%s.jpg" alt="" width="12" height="12" />
		</span>
</span>
							<span class="name">%s</span>
