<div id="summary-stats-simple" class="summary-stats-simple"<?php echo WoW_Template::GetPageIndex() == 'character_profile_advanced' ? ' style="display:none;"' : null; ?>>
	...
	<li data-id="arcaneres" class=" has-icon">
		...
		<span class="icon-frame frame-12">
			<img src="http://www.wowdb.tw/icons/middle/resist_arcane.jpg" alt="" width="12" height="12" />
		</span>
</span>
	...
	<li data-id="fireres" class=" has-icon">
			<span class="icon"> 
		<span class="icon-frame frame-12">
			<img src="http://www.wowdb.tw/icons/middle/resist_fire.jpg" alt="" width="12" height="12" />
		</span>
</span>
	...
	<li data-id="frostres" class=" has-icon">
			<span class="icon"> 
		<span class="icon-frame frame-12">
			<img src="http://www.wowdb.tw/icons/middle/resist_frost.jpg" alt="" width="12" height="12" />
		</span>
</span>
	...
	<li data-id="natureres" class=" has-icon">
			<span class="icon">
		<span class="icon-frame frame-12">
			<img src="http://www.wowdb.tw/icons/middle/resist_nature.jpg" alt="" width="12" height="12" />
		</span>
</span>
	...
	<li data-id="shadowres" class=" has-icon">
			<span class="icon">
		<span class="icon-frame frame-12">
			<img src="http://www.wowdb.tw/icons/middle/resist_shadow.jpg" alt="" width="12" height="12" />
		</span>
</span>
