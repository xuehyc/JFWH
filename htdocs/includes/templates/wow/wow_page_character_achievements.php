...
<h3 class="category"><?php echo $categoryInfo['name']; ?></h3><?php
    ...
    foreach($achievements as $ach) {
                ...
                if(isset($criteria['progressBar']) && $criteria['progressBar']) {
                    ...
                    elseif(isset($criteria['subAchievement'])) {
                        $criterias_list .= sprintf('
                            ...
                            <span  class="icon-frame frame-36" style=\'background-image: url("http://www.wowdb.tw/icons/middle/%s.jpg");\'> </span>
        ...
        if(isset($ach['reward_item'])) {
            ...
            $ach['titleReward'] = sprintf('%s: <a href="%s/wow/' . WoW_Locale::GetLocale() . '/item/%d" class="color-q%d">%s</a>', $tmp_str[0], WoW::GetWoWPath(), $ach['reward_item']['entry'], $ach['reward_item']['Quality'], $ach['reward_item']['name']);
        }
        echo sprintf('
        <li class="achievement %s" data-id="%d" data-href="#%d:a%d">
            ...
            <span class="icon-frame frame-50">
                <img src="http://www.wowdb.tw/icons/middle/%s.jpg" alt="" width="50" height="50" />
            </span>
