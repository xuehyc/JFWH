...
<?php WoW_Template::LoadTemplate('block_profile_menu'); ?>
    ...
    foreach($item_slots as $slot => $data) {
        ...
        if(!$item_info || $item_info['item_id'] == 0) {
            ...
            <div class="slot-inner">
            <div class="slot-contents"><a href="%s/wow/' . WoW_Locale::GetLocale() . '/item/%d" class="item" data-item="%s"><img src="http://www.wowdb.tw/icons/middle/%s.jpg" alt="" /><span class="frame"></span></a>
            </div>
            </div>
