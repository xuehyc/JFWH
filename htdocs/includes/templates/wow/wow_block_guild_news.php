                    ...
                    foreach($guild_feed as $feed) {
                        switch($feed['type']) {
                            case TYPE_ACHIEVEMENT_FEED:
                                ...
                                $feed_link = sprintf('<a href="%s/wow/%s/character/%s/%s/achievement#%d:a%d" rel="np" onmouseover="Tooltip.show(this, \'#news-tooltip-%d\');">
                                <span  class="icon-frame frame-18" style=\'background-image: url("http://www.wowdb.tw/icons/middle/%s.jpg");\'></span>
                            </a>', WoW::GetWoWPath(), WoW_Locale::GetLocale(), WoW_Guild::GetGuildRealmName(), $feed['charName'], $feed['category'], $feed['id'], $i, $feed['icon']);
                                ...
                                $achievement_link = sprintf('<a href="%s/wow/%s/character/%s/%s/achievement#%d:a%d" rel="np" onmouseover="Tooltip.show(this, \'#news-tooltip-%d\');">%s</a>', WoW::GetWoWPath(), WoW_Locale::GetLocale(), WoW_Guild::GetGuildRealmName(), $feed['charName'], $feed['category'], $feed['id'], $i, $feed['name']);
                        ...
                        <dd>
                            ...
                            <div id="news-tooltip-%d" style="display: none">
                                <div class="item-tooltip">
                                    <span  class="icon-frame frame-56" style=\'background-image: url("http://www.wowdb.tw/icons/middle/%s.jpg");\'></span>
                                    <h3>%s</h3>
