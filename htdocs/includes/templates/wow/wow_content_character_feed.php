        ...
        foreach($feeds as $event) {
            switch($event['type']) {
                case TYPE_ACHIEVEMENT_FEED:
                    ...
                    <span  class="icon-frame frame-18" style=\'background-image: url("http://www.wowdb.tw/icons/middle/%s.jpg");\'></span></a>
                    %s
                    <div id="achv-tooltip-%d" style="display: none"><div class="item-tooltip"><span class="icon-frame frame-56" style=\'background-image: url("http://www.wowdb.tw/icons/middle/%s.jpg");\'></span>
                ...
                case TYPE_ITEM_FEED:
                    ...
                    <span  class="icon-frame frame-18" style=\'background-image: url("http://www.wowdb.tw/icons/middle/%s.jpg");\'>
                    </span>
                    </a>
                    %s
                    </dd>
