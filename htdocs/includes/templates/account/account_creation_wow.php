	...
	<div class="leftColumn">
		...
		<a class="learnMore" href="<?php echo WoW_Locale::GetLocale(LOCALE_DOUBLE); ?>/games/cataclysm/index.html" onclick="pageTracker._trackEvent('WoW Trial Signup', 'Learn More', 'EU', '<?php echo WoW_Locale::GetLocale(LOCALE_PATH); ?>'); window.open(this.href);return false;">
...
<tr id="emailAddressRow" class="<?php echo WoW_Template::GetPageData('creation_error') ? 'invalid' : null; ?>">
	...
	<div class="footer">
		...
		<div class="needHelp">
			...
			<a href="/wow/en/forum/index.xml?locale=<?php echo WoW_Locale::GetLocale(LOCALE_PATH); ?>" onclick="window.open(this.href);return false;"><?php echo WoW_Locale::GetString('copyright_bottom_support'); ?></a>
		</div>
