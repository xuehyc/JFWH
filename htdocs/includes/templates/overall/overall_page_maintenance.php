...
<head>
    ...
    body.ko-kr { font-family: "Dotum", "??", "Helvetica", "AppleGothic", sans-serif; }
    body.ko-kr .info .title,
    body.ko-kr .info .twitter,
    body.ko-kr .footer { font-family: "Malgun Gothic", "?? ??", "AppleGothic", "Dotum", "??", "Trebuchet MS", "Arial", sans-serif; }
    ...
    <div class="wrapper">
        ...
        <div class="notice" id="pt-br:notice" style="display: none;">
            ...
            <div class="info">
                ...
                <p class="short">Os websites da Blizzard est?o em manuten??o para melhorar sua experiência de navega??o. Obrigado por sua?paciência!</p>
                <?php
                if(WoWConfig::$TwitterAccount != null) {
                    echo '<div class="twitter">
                    Para mais informa??es, siga <a tabindex="1" target="_blank" href="http://twitter.com/' . WoWConfig::$TwitterAccount . '">@' . WoWConfig::$TwitterAccount . '</a> no?Twitter.
                </div>';
                }
                ?>
            </div>
        ...
        <div class="notice" id="fr-fr:notice" style="display: none;">
            <h1 class="logo"><span>Battle.net</span></h1>
            <div class="info">
                <div class="title">Nous serons bient?t de?retour?!</div>
        ...
        <div class="notice" id="pl-pl:notice" style="display: none;">
            <h1 class="logo"><span>Battle.net</span></h1>
            <div class="info">
                <div class="title">Nied?ugo wracamy!</div>
                <p class="short">Na stronach Blizzard trwaj? w?a?nie prace administracyjne. Dzi?kujemy za?cierpliwo??!</p>
                <?php
                if(WoWConfig::$TwitterAccount != null) {
                    echo '<div class="twitter">
                    Aktualne informacje mo?na znale?? ?ledz?c profil <a tabindex="1" target="_blank" href="http://twitter.com/' . WoWConfig::$TwitterAccount . '">@' . WoWConfig::$TwitterAccount . '</a> na?Twitterze.
                </div>';
                }
                ?>
            </div>
        ...
        <div class="footer" id="es-mx:footer" style="display: none;">
            ...
            <span class="language">América?– Espa?ol?(AL)</span>
        ...
        <div class="footer" id="en-gb:footer" style="display: none;">
            ...
            <span class="legal">
                ...
                <a target="_blank" href="" tabindex="2">Legal</a>
                <a target="_blank" href="" tabindex="2">Privacy Policy</a>
                <a target="_blank" href="" tabindex="2">Copyright Infringement</a>
            </span>
        ...
        <div class="footer" id="de-de:footer" style="display: none;">
            ...
            <span class="legal">
                ...
                <a target="_blank" href="" tabindex="2">Rechtliches</a>
                <a target="_blank" href="" tabindex="2">Datenschutzrichtlinien</a>
                <a target="_blank" href="" tabindex="2">Copyright-Versto?</a>
            </span>
        ...
        <div class="footer" id="es-es:footer" style="display: none;">
            ...
            <span class="legal">
                ...
                <a target="_blank" href="http://eu.blizzard.com/company/legal/    <a target="_blank" href="http://eu.blizzard.com/company/about/privacy.html/a>
                <a target="_blank" href="http://eu.blizzard.com/company/about/infringementnotice.html          <span class="language">Europa?– Espa?ol (EU)</span>
...
ef="http://eu.blizzard.com/company/about/privacy.html" tabindex="2">Politique de?confidentialité</a>
u.blizzard.com/company/about/infringementnotice.html" tabindex="2">Droits</a>
            </span>
        ...
        <div class="footer" id="it-it:footer" style="display: none;">
            ...
            <span class="legal">
                ...
                <a target="_blank" about/privacy.html" tabindex="2">Politica sulla?privacy</a>
                <a target="_blank" href="http://eu.blizzbindex="2">Menzioni sul</a>
            </span>
     ...
     le="display: none;">
            ...
            <span class="copyright">?2011 Blizzard Entertainment, Inc. Wszystkie prawa?zastrze?one</span>

            <span class="legal">
                <a target="_blank" href="http://eu.blizzard.com/company/about/termsofuse.html" tabindex="2">Warunki u?ytkowania</a>
                <a target="_blank" href="http://eu.blizzard.com/company/legal/" tabindex="2">Prawne</a>
                <a target="_blank" href="http://eu.blizzard.com/company/about/privacy?ci</a>
                <a target="_blank" href="http://eu.blizzard.com/company/about/infringementnotice.html" tabi   </span>

            <span class="language">Europa?– Polski</span>

        </div>

        <div class="footer" id="ru-ruopyright">??Blizzard Entertainment, 2011?г.<br />Все права?защищены</span>
            ...
            <span class="legal">
                ...
                <a target="_blank" href="http://eu.blizzard.com/company/about/privacy.html" tabindex="2">Пльности</a>
                <a target="_blank" href="http://eu.blizzard.com/company/about/infringementnotice.html" tabindex="2">Авт?          <span class="language">Европа?– Русский</span>

        </div>

        <script>
        (function(currentLocale) {
            var doc = documeif (currentLocale !== 'en-us') {
