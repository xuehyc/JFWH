<ul class="service-bar">
			...
			<li class="service-cell service-account"><a href="<?php echo WoW::GetWoWPath(); ?>/account/management/?lnk=1" class="service-link" tabindex="50" accesskey="3"><?php echo WoW_Locale::GetString('template_servicebar_account'); ?></a></li>
				<li class="service-cell service-support"><a href="/wow/en/forum/" class="service-link" tabindex="50" accesskey="4"><?php echo WoW_Locale::GetString('template_servicebar_support'); ?></a></li>
					...
					<div class="explore-primary">
						<ul class="explore-nav">
							...
							<li>
								...
								<li>
									<a href="/wow/en/forum/" tabindex="55">
						...
						<div class="explore-links">
							...
							<ul>
									...
									<li><a href="" tabindex="55"><?php echo WoW_Locale::GetString('template_servicebar_explore_menu_more_link2'); ?></a></li>
