...
?>
    ...
    <div id="homepage">
        <div class="game-column" id="home-game-sc2">
            <a href="" class="game-promo"><span class="game-tip"><?php echo WoW_Locale::GetString('template_bn_sc2_cs'); ?></span></a>

            <ul>
                <li>
                    <?php echo WoW_Locale::GetString('template_bn_sc2_cs_status'); ?><br />
                    <span class="text-red">游戏离线</span>
                </li>
            </ul>
        </div>
        ...
        <div class="game-column" id="home-game-wow">
            ...
            <ul>
                <li>
                    ...
                    <span class="text-green">游戏<?php echo WoW_Locale::GetString('template_online_caption'); ?></span>
                </li>
            </ul>
        </div>

        <div class="game-column" id="home-game-d3">
            <a href="" class="game-promo"><span class="game-tip"><?php echo WoW_Locale::GetString('template_bn_diablo3_cs'); ?></span></a>
