<div id="section">
		...
		<div class="game-selection " id="game-WOWX3" onclick="openGameDialog(this, '#dialog-WOWX3');" title="World of Warcraft: Cataclysm">
			<img class="box" src="<?php echo WoW::GetWoWPath(); ?>/static/local-common/images/game-boxes/<?php echo WoW_Locale::GetLocale(LOCALE_DOUBLE); ?>/wowx3.png" alt="" />
	...
	<span class="clear"><!-- --></span>
		...
		<div class="game-selection-dialog" id="dialog-S2" style="display: none">
			<div class="game-label">
				...
				<a href="" class="dialog-button community">
					<span>Сообщество</span>
				</a>
